<x-layouts.app>
    ...
    <div class="bg-white shadow-sm w-full rounded-lg mt-4">
        ...
        <div class="p-6 font-ibm">
            <form action="{{ route('garment_types.update', $garmentType->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <select name="status" id="status-select"
                        ...
                        <option value="1" {{ $garmentType->status === 1 ? 'selected' :'' }}>Active</option>
                        <option value="0" {{ $garmentType->status === 0 ? 'selected' :'' }}>Disable</option>
