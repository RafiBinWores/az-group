<x-layouts.app>
    ...
    <div class="bg-white shadow-sm w-full rounded-lg mt-4">
        ...
        <div class="p-6 font-ibm">
            <form id="cutting-form" action="{{ route('washes.store') }}" method="POST">
                @csrf
                <div class="mb-4">
                ...
                if (colors) {
                    ...
                    colors.forEach((row, idx) => {
                        ...
                        div.innerHTML = `
                            ...
                            <input type="number" readonly min="0" placeholder="Order Qty" value="${row.qty}" class="border border-gray-300 bg-gray-100 rounded-xl px-3 py-2 w-1/6" name="wash[${idx}][order_qty]">
                            <input type="text" min="0" placeholder="Factory" class="border border-gray-300 rounded-xl px-3 py-2 w-2/6" name="wash[${idx}][factory]">
                            <input type="number" min="0" placeholder="Send" class="border border-gray-300 rounded-xl px-3 py-2 w-1/6" name="wash[${idx}][send]">
                            <input type="number" min="0" placeholder="Received" class="border border-gray-300 rounded-xl px-3 py-2 w-1/6" name="wash[${idx}][received]">
                        `;
