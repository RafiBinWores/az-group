<x-layouts.app>
    {{-- Page title --}}
    <x-slot name="title">Wash List | AZ Group</x-slot>
    {{-- Page title end --}}

    {{-- Page header --}}
    <x-slot name="header">Wash List</x-slot>
    {{-- Page header end --}}
                        ...
                        <tr class="border-b-gray-400" data-order-id="{{ $wash->id }}">
                            ...
                            <td class="px-4 py-2 flex gap-5 items-center">
                                ...
                                <button
                                    ...
                                    data-id="{{ $wash->id }}" title="Delete"><i
                                ...
                                success: function(response) {
                                    if (response.status) {
                                        showToast(
                                            "success",
                                            response.message ||
                                            "Wash report deleted successfully"
                                        );
